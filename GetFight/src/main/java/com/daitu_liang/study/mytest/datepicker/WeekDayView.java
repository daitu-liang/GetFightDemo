...
public class WeekDayView extends View {
	...
	//下横线颜色
	private int mBottomLineColor = Color.parseColor("#00000000");
	//背景颜色
	private int mBG = Color.parseColor("#5F627380");
	//周一到周五的颜色
	private int mWeedayColor = Color.parseColor("#DC487193");
	//周六、周日的颜色
	private int mWeekendColor = Color.parseColor("#DC487193");
	//线的宽度
