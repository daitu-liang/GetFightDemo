package com.daitu_liang.study.mytest.tinker;
...
public class TinkerActivity extends AppCompatActivity {
    @BindView(R.id.load_thinker_btn)
    Button loadThinkerBtn;
    @BindView(R.id.load_thinker_show_info_btn)
    Button loadThinkerShowInfoBtn;
