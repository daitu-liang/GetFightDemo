...
public class MainHomeActivity2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainHomeActivity2.this, LoginActivity.class));
            }
        });
        initTabLayout();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        // Handle action bar item_book clicks here. The action bar will
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            startActivity(new Intent(MainHomeActivity2.this, MainActivity.class));
        } else if (id == R.id.nav_gallery) {
            startActivity(new Intent(MainHomeActivity2.this, PaintActivity.class));
